...
The sequence \cite{oeis} gives the number of monominos which are needed to tile the $n \times n$ square with t-tetrominos and monominos. Theorem \ref{main} shows that this sequence is trivially given by $n^2/4, (n^2-1)/4-1, n^2/4-1, (n^2-1)/4-1$.
