...
\theorem{Every rectangle of side length at least 12 can be tiled with T-tetrominos and either 0, 2, 3 or 5 monominos.}
Clearly the number of monominos depends only on the number of grid squares modulo 4.

In the terminology used by Hochberg, the \emph{gap cap} of the T-tetromino is 5.
