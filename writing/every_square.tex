...
\begin{figure}
\input{ones_image}
\caption{A tiling of $A_{4k+1}$ can be extended to a tiling of (a rotated copy of) $A_{4k+3}$.}
\label{ones}
\end{figure}

\begin{figure}
\input{threes_image}
\caption{A tiling of $A_{4k+3}$ can be extended to a tiling of (a rotated copy of) $A_{4(k+1)+1}$.}
\label{threes}
\end{figure}
